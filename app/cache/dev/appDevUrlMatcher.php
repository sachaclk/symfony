    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/v')) {
            ...
            if (0 === strpos($pathinfo, '/validate') && preg_match('#^/validate/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'validate')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::validateAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/quote')) {
            ...
            // edit_quote
            if (0 === strpos($pathinfo, '/quote/edit') && preg_match('#^/quote/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // moderate
        if ($pathinfo === '/moderate') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::moderateAction',  '_route' => 'moderate',);
        }
